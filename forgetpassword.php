...
<head>
  ...
  <title>e-Journal | ForgetPassword</title>
...
<main>
    <div class="container">
      ...
      <section class="section forgetpassword min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4"><?php echo htmlspecialchars("Forget Password", ENT_QUOTES, 'UTF-8'); ?></h5>
                    <p class="text-center small"><?php echo htmlspecialchars("Input your new password", ENT_QUOTES, 'UTF-8'); ?></p>
                  </div>

                  <form method="post" action="forgetpassword.php" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourName" class="form-label"><?php echo htmlspecialchars("New Password", ENT_QUOTES, 'UTF-8'); ?></label>
                      <input type="password" name="password_1" class="form-control" id="password" required>
                      <div class="invalid-feedback"><?php echo htmlspecialchars("Please, enter your password!", ENT_QUOTES, 'UTF-8'); ?></div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback"><?php echo htmlspecialchars("Please enter your password!", ENT_QUOTES, 'UTF-8'); ?></div>
                      <p id="message"><?php echo htmlspecialchars("Confirmation Password is", ENT_QUOTES, 'UTF-8'); ?> <span id="strength"></span></p>
                    </div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="reset_password"><?php echo htmlspecialchars("Confirm", ENT_QUOTES, 'UTF-8'); ?></button>
                    </div>

                    <div class="col-12">
                      <p class="small mb-0"><?php echo htmlspecialchars("Already have an account?", ENT_QUOTES, 'UTF-8'); ?> <a href="login.php"><?php echo htmlspecialchars("Log in", ENT_QUOTES, 'UTF-8'); ?></a></p>
                    </div>
                  </form>
