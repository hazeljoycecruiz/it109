...
//     // Reset styles when the input is empty
...
//     pass.style.borderColor = "#ff5925";
//     strengthMsg.style.color = "#ff5925";
//   } else if (pass.value.length >= 12 && pass.value.length < 20) {
//     strengthMsg.innerHTML = "Moderate";
//     pass.style.borderColor = "green";
//     strengthMsg.style.color = "green";
//   } else if (pass.value.length >= 20) {
//     strengthMsg.innerHTML = "Strong";
//     pass.style.borderColor = "#26d730";
//     strengthMsg.style.color = "#26d730";
//   }
// });

// confirmpass.addEventListener('input', () => {
//   // Check if both inputs are empty
//   if (pass.value.trim().length === 0 && confirmpass.value.trim().length === 0) {
